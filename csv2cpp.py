...
for parent, dirnames, filenames in os.walk(g_data.g_config_path): 
	...
	for filename in filenames:                    
		...
		#config_py.h
		file_merge1 = util.Insert_line(g_data.g_code_path + "config_py.h", "//Merge1", output_config_mgr_merge1())  
		file_merge1.inserted_new_file()  
		file_merge2 = util.Insert_line(g_data.g_code_path + "config_py.h", "//Merge2", output_config_mgr_merge2())  
		file_merge2.inserted_new_file() 

		#config_py.cpp
		file_merge3 = util.Insert_line(g_data.g_code_path + "config_py.cpp", "//Merge3", output_config_mgr_merge3(filename))  
		file_merge3.inserted_new_file() 
